    ...
    <div className="max-wrapper about-wrapper"id="about">
        <div className="about">
            <div className="about-content">
                <h1>About Us</h1>
                <p>Speedway Movers Delivery Company is one of the leading providers of courier services, sea freight and air freight services in the world. Our primary focus is to ensure that our customers receive their items at the desired destination at the desired time.</p>
